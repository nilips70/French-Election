...
##reading the data
databas_15_2 <- read_csv("databas_15_2.csv")

#sampling
samp <- sample(1:nrow(databas_15_2), 500)
samp_database_15_2 <-  databas_15_2[samp, ]

#write_xlsx(samp_database_15_2,"samp_database_15_2.xlsx")

#reading the samp_database_14_3.xlsx
newdata <- read_excel("samp_database_15_2.xlsx")
