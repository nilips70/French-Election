...
##reading the data
databas_18_3 <- read_csv("databas_18_3.csv")

#sampling
samp <- sample(1:nrow(databas_18_3), 500)
samp_databas_18_3 <-  databas_18_3[samp, ]

#write_xlsx(samp_databas_18_3,"samp_databas_18_3.xlsx")

#reading the samp_database_14_3.xlsx
newdata <- read_excel("samp_databas_18_3.xlsx")
