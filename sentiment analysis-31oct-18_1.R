...
##reading the data
databas_18_1 <- read_csv("databas_18_1.csv")

#sampling
samp <- sample(1:nrow(databas_18_1), 500)
samp_databas_18_1 <-  databas_18_1[samp, ]

#write_xlsx(samp_databas_18_1,"samp_databas_18_1.xlsx")

#reading the samp_database_14_3.xlsx
newdata <- read_excel("samp_databas_18_1.xlsx")
