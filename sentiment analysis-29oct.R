...
##reading the data
database_14_3 <- read_excel("database_14_3.xlsx")

#sampling
samp <- sample(1:nrow(database_14_3), 500)
samp_database_14_3.xlsx <-  database_14_3[samp, ]

#write_xlsx(samp_database_14_3.xlsx,"samp_database_14_3.xlsx.xlsx")

#reading the samp_database_14_3.xlsx
newdata <- read_excel("samp_database_14_3.xlsx")
