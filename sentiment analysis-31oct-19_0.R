...
##reading the data
databas_19_0 <- read_csv("databas_19_0.csv")

#sampling
samp <- sample(1:nrow(databas_19_0), 500)
samp_databas_19_0 <-  databas_19_0[samp, ]

#write_xlsx(samp_databas_19_0,"samp_databas_19_0.xlsx")

#reading the samp_database_14_3.xlsx
newdata <- read_excel("samp_databas_19_0.xlsx")
